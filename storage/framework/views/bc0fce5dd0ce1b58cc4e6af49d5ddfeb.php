    ...
    <section class="bg-slate-50 border-b border-slate-200 pt-16 pb-12">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-center gap-2 mb-6 text-sm text-slate-500">
                <a href="<?php echo e(route('home')); ?>" class="hover:text-blue-600 transition-colors">Beranda</a>
                <span>&rsaquo;</span>
                <a href="<?php echo e(route('publik.publikasi.berita.index')); ?>" class="hover:text-blue-600 transition-colors">Berita Desa</a>
                <span>&rsaquo;</span>
                <span class="text-slate-400 truncate max-w-[200px] sm:max-w-xs"><?php echo e($berita->judul); ?></span>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.user','data' => ['class' => 'size-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        <time datetime="<?php echo e($berita->published_at ?? $berita->created_at); ?>">
    ...
    <section class="bg-white py-12 sm:py-16">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <!-- Featured Image -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($berita->gambar): ?>
                <div class="mb-12 rounded-2xl overflow-hidden shadow-lg border border-slate-100 bg-slate-100 relative aspect-video">
                    <img src="<?php echo e(Storage::url($berita->gambar)); ?>" alt="<?php echo e($berita->judul); ?>" class="w-full h-full object-cover">
                </div>
            ...
            <div class="prose prose-slate md:prose-lg max-w-none prose-headings:font-bold prose-a:text-blue-600 hover:prose-a:text-blue-500 prose-img:rounded-xl">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($berita->ringkasan): ?>
            ...
            <div class="mt-16 pt-8 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(request()->url())); ?>" target="_blank" class="h-10 w-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-blue-100 hover:text-blue-700 transition-colors">
                    ...
                    <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($berita->judul)); ?>" target="_blank" class="h-10 w-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-sky-100 hover:text-sky-500 transition-colors">
                    ...
                    <a href="https://wa.me/?text=<?php echo e(urlencode($berita->judul . ' ' . request()->url())); ?>" target="_blank" class="h-10 w-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-emerald-100 hover:text-emerald-600 transition-colors">
                ...
                <a href="<?php echo e(route('publik.publikasi.berita.index')); ?>" class="inline-flex items-center text-sm font-semibold text-blue-600 hover:text-blue-800">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Website Work\desa-tatung-laravel\resources\views/pages/publikasi/berita/show.blade.php ENDPATH**/ ?>