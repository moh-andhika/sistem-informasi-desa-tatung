...
@section('content')
    <article class="bg-white  overflow-hidden mb-10">
        {{-- Featured Image --}}
        @if($berita->gambar)
            ...
            <div class="mt-8 pt-6  flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex gap-2">
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->url()) }}" target="_blank" rel="noopener" class="size-9  bg-slate-50  flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white hover: transition-all " aria-label="Bagikan ke Facebook">
                        ...
                        <a href="https://wa.me/?text={{ urlencode($berita->judul . ' ' . request()->url()) }}" target="_blank" rel="noopener" class="size-9  bg-slate-50  flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white hover: transition-all " aria-label="Bagikan ke WhatsApp">
