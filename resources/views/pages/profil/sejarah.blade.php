...
@section('content')
    <div class="space-y-6">
        <section aria-labelledby="history-title" class="bg-white rounded-lg border border-green-100 shadow-sm overflow-hidden">
            <div class="bg-[#2E7D32] px-6 py-4 flex items-center justify-between">
                <h2 class="text-sm font-black text-white uppercase tracking-widest" id="history-title">Sejarah &amp; Asal-usul Desa</h2>
                <flux:icon.book-open class="size-5 text-white/70" />
            </div>
            <div class="p-8 sm:p-12">
                <div class="prose prose-slate prose-sm sm:prose-base max-w-none prose-headings:font-black prose-headings:uppercase prose-headings:tracking-tight prose-headings:text-green-900 prose-p:text-slate-700 prose-p:leading-relaxed">
                    <p>
                    ...
                    <img src="{{ asset('assets/images/background.jpg') }}" alt="Pemandangan Alam Desa Tatung" class="rounded-lg border border-green-100 shadow-lg my-8 w-full h-[400px] object-cover">
                    ...
                    <div class="not-prose my-10 overflow-x-auto rounded-lg border border-green-100 shadow-sm">
                        <table class="w-full text-left text-xs uppercase tracking-widest font-black">
                            ...
                            <tbody class="divide-y divide-green-50 text-slate-700">
                                <tr class="hover:bg-green-50 transition-colors">
                                    <td class="px-6 py-4 font-bold text-green-900">1998 - 2006</td>
                                ...
                                <tr class="hover:bg-green-50 transition-colors">
                                    <td class="px-6 py-4 font-bold text-green-900">2006 - 2014</td>
                                ...
                                <tr class="hover:bg-green-50 transition-colors">
                                    <td class="px-6 py-4 font-bold text-green-900">2014 - Sekarang</td>
...
@section('content')
    <div class="space-y-6">
        <section aria-labelledby="history-title" class="bg-white rounded-sm border border-slate-200 shadow-sm overflow-hidden">
            <div class="bg-prt-primary px-6 py-4 flex items-center justify-between">
                <h2 class="text-sm font-black text-white uppercase tracking-widest" id="history-title">Sejarah & Asal-usul Desa</h2>
                <flux:icon.book-open class="size-5 text-white/70" />
            </div>
            <div class="p-8 sm:p-12">
                <div class="prose prose-slate prose-sm sm:prose-base max-w-none prose-headings:font-black prose-headings:uppercase prose-headings:tracking-tight prose-headings:text-slate-900 prose-p:text-slate-800 prose-p:leading-relaxed">
                    <p>
                        Desa Tatung memiliki sejarah yang kaya dan berakar pada masa lalu yang legendaris di wilayah Kabupaten Ponorogo. Menurut cerita turun-temurun dari para sesepuh desa, nama "Tatung" diyakini berasal dari kata dalam bahasa Jawa kuno yang menggambarkan kondisi geografis atau peristiwa penting pada saat pembukaan lahan pertama kali.
                    </p>

                    <img src="{{ asset('assets/images/background.jpg') }}" alt="Pemandangan Alam Desa Tatung" class="rounded-sm border border-slate-200 shadow-lg my-8 w-full h-[400px] object-cover">
                    ...
                    <div class="not-prose my-10 overflow-x-auto rounded-sm border border-slate-200">
                        <table class="w-full text-left text-xs uppercase tracking-widest font-black">
                            <caption class="sr-only">Daftar Kepala Desa Tatung dari masa ke masa</caption>
