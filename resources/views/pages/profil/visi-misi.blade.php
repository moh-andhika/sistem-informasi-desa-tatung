        ...
        <section aria-labelledby="visi-title" class="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div class="py-14 text-center px-6 sm:px-16 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <flux:icon.sparkles class="size-8 text-prt-accent mx-auto mb-5" />
            ...
            <div class="p-8">
                <div class="space-y-3" role="list" aria-label="Daftar Misi Desa Tatung">
                    ...
                    <div class="flex gap-5 group p-5 rounded-lg hover:bg-blue-50/40 transition-all" role="listitem">
                        ...
                        <div class="pt-1">
                            <h3 class="text-base font-black text-slate-900 uppercase tracking-normal mb-2 group-hover:text-prt-primary transition-colors">{{ $item['title'] }}</h3>
