    ...
    <div class="space-y-12">
        ...
        <section aria-labelledby="visi-title" class="bg-white  overflow-hidden">
            <div class="bg-[#024ad8] px-6 py-4 flex items-center justify-between">
                <h2 class="text-sm font-black text-white uppercase tracking-wide" id="visi-title">Visi Desa Tatung</h2>
            ...
            <div class="py-14 text-center px-6 sm:px-16 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <flux:icon.sparkles class="size-8 text-[#ff5050] mx-auto mb-5" />
                    <p class="text-xl sm:text-2xl font-bold text-slate-900 italic leading-relaxed tracking-normal max-w-3xl mx-auto">
        ...
        <section aria-labelledby="misi-title" class="bg-white  overflow-hidden">
            <div class="bg-[#0e3191] px-6 py-4 flex items-center justify-between">
                <h2 class="text-sm font-black text-white uppercase tracking-wide" id="misi-title">Misi Desa Tatung</h2>
            ...
            <div class="p-8">
                <div class="space-y-3" role="list" aria-label="Daftar Misi Desa Tatung">
                    ...
                    <div class="flex gap-5 group p-5   hover: hover:bg-blue-50/40 transition-all" role="listitem">
                        <div class="shrink-0 size-14  bg-blue-100  flex items-center justify-center text-[#024ad8] font-black text-xl group-hover:bg-[#024ad8] group-hover:text-white transition-all ">
                            {{ $item['id'] }}
                        </div>
                        <div class="pt-1">
                            <h3 class="text-base font-black text-slate-900 uppercase tracking-normal mb-2 group-hover:text-[#024ad8] transition-colors">{{ $item['title'] }}</h3>
